...
Ext.extend(BannerTags.grid.Items, MODx.grid.Grid, {
    ...
    editTags: function (btn, e, row) {
        ...
        location.href = '?a=tags&namespace='+MODx.request.namespace+'&id='+id;
    ...
    getFields: function () {
        return ['id', 'image','name', 'description', 'category_id','active', 'actions'];
    },
    ...
    getColumns: function () {
        return [{
            ...
            header: _('bannertags_item_parent'),
            dataIndex: 'category_id',
            sortable: false,
            width: 250,
        }, {
            header: _('bannertags_item_image'),
            dataIndex: 'image',
            sortable: true,
            width: 200,
            ...
            header: _('bannertags_item_description'),
            dataIndex: 'description',
            sortable: false,
            width: 250,
        },  {
            header: _('bannertags_item_active'),
            dataIndex: 'active',
            renderer: BannerTags.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
    ...
    _renderImage: function (value, props, row) {
        return value ? '<img src="/' + value + '" alt=""  width="200" />' : String.format('Not image');
    },
