...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('bannertags_core_path', null,
                    $modx->getOption('core_path') . 'components/bannertags/') . 'model/';
            $modx->addPackage('bannertags', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/bannertags/model/schema/bannertags.mysql.schema.xml';
